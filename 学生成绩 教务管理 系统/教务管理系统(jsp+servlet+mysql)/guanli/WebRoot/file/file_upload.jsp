...
<TABLE cellSpacing=0 cellPadding=0 width=761 align=center border=0>
  ...
  <TR>
    ...
    <TD width=150 bgcolor = "#8BA9E5" height=37>
      ...
      href="http://localhost:8080/jiaowu/Admin_Update.jsp">后台管理/上传管理-上传资料</A></A></MARQUEE></FONT>
          ...
          <TD height="319" vAlign=top bgColor=#ffffff><BR>
            <TABLE cellSpacing=0 cellPadding=0 align=center border=0>
              ...
              <TR>
                ...
                <TD width=290 
background=images/qline2.gif><strong>上传管理/上传资料</strong></TD>
                <TD width=140 
...
border=0 align=center cellpadding=0 cellspacing=0>
                <tbody>
                  <tr>
                    <td height="270" class=text><CENTER>
请输入上传的文件标题和选择上传的文件</CENTER>
...
<p>
<BR><center><Input type=submit name="g" value="上传" ></center>
</Form>
					  <br>                    
                       </td>
                  </tr>
