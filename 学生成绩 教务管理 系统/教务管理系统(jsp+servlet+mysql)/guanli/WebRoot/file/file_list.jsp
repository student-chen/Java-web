...
border=0 align=center cellpadding=0 cellspacing=0>
	...
	function addUser() {
		window.self.location = "file_upload.jsp";	
	}
						...
						<tr>
							<td class="rd8">
								<input type="checkbox" name="selectFlag" class="checkbox1"
									value="<bean:write name="file" property="file_name"/>">
							</td>
							<td class="rd8">
								<bean:write name="file" property="file_name" />
							</td>
							<td class="rd8">
								<bean:write name="file" property="file_path" />
							</td>
						    <td class="rd8">
								<bean:write name="file" property="file_date" format="yyyy-MM-dd HH:mm:ss" />
							</td>
						</tr>
					</logic:iterate>
				</logic:notEmpty>
