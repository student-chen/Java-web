...
{   
  if (checkspace(document.addAdmin.username.value)) {
	document.addAdmin.username.focus();
    alert("对不起，姓名不能为空");
	return false;
  }
    if(checkspace(document.addAdmin.password.value) || document.addAdmin.password.value.length < 3 || document.addAdmin.password.value.length >20) {
...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
    ...
    <form method="post" name="addAdmin" action="AddServlet">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>添加管理员- 必填内容</td>
		</tr>
		<tr>
			<td class="altbg1" width="21%">用户名:</td>
			<td class="altbg2"><input type="text" name="username" size="25"
				maxlength="25"><font color="red">*不能为空</font></td>
		</tr>
		 
		<tr>
			<td class="altbg1">密&nbsp;&nbsp;码:</td>
			<td color="red" class="altbg2"><input type="password" name="password" size="25"> <font color="red">*字符长度必须在6-20之间</font></td> 		 			 	 
		</tr>
	...
	<br>
	<center><input onClick="return checkuserinfo();" type="submit" name="regsubmit" value="提 &nbsp; 交"></center>
	</form>
