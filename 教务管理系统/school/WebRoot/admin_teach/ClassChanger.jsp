...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<br>
	-->
	<form method="post" name="register" action="ClassUpdateServlet">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>班级注册 - 必填内容</td>
		</tr>
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="0" end="0">
					<input type="text" name="cid" size="25" maxlength="25"
		...
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="1" end="1">
					<input type="text" name="cname" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
		...
		<tr>
			<td class="altbg1" width="21%">班级类型:</td>
			<td class="altbg2">
			<c:forEach var="list" items="${mylist}">

				<c:forEach var="temp" items="${list}" begin="2" end="2">
					<input type="text" name="ctype" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
			</c:forEach></td>
		</tr>
