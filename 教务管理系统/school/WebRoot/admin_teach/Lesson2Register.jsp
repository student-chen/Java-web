...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<br>
	-->
	<form method="post" name="register" action="Lesson2RegisterServlet">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>选修课程注册 - 必填内容</td>
		</tr>
		<tr>
			<td class="altbg1" width="21%">选修课程名:</td>
			<td class="altbg2"><input type="text" name="lesson2name" size="25"
				maxlength="25">
		</tr>
		<tr>
			<td class="altbg1" width="21%">预修课程（例：高数2预修高数1）:</td>
			<td class="altbg2"><select name="lesson2needid">
		...
		<tr>
			<td class="altbg1" width="21%">学时:</td>
			<td class="altbg2"><input type="text" name="lesson2time" size="25"
				maxlength="25">
		</tr>
		<tr>
			<td class="altbg1" width="21%">学分:</td>
			<td class="altbg2"><input type="text" name="lesson2score" size="25"
				maxlength="25">
		</tr>
