...
function check()
{
    var username = document.register.tnumber.value;
    var name = document.register.tname.value;
    var password = document.register.password.value;
    var password2 = document.register.password2.value;
    var skill = document.register.tskill.value;
    
	if((username == "")||(!username.match(/^[0-9a-z]*$/i))||(name == "")||(!name.match(/^[0-9a-z]*$/i)))
	{
		alert("你提交了非法字符！");
		return false;
	}
...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<br>
	-->
	<form method="post" name="register" action="TeaUpdateServlet">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>老师修改信息 - 必填内容</td>
		</tr>
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="0" end="0">
					<input type="text" name="tid" size="25" maxlength="25"
		...
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="1" end="1">
					<input type="text" name="tnumber" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
		...
		<tr>
			...
			<c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="2" end="2">
					<input type="text" name="tname" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
			</c:forEach></td>
		</tr>
		...
		<tr>
			<td class="altbg1" width="21%">技能:</td>
			<td class="altbg2">
			<c:forEach var="list" items="${mylist}">

				<c:forEach var="temp" items="${list}" begin="3" end="3">
					<input type="text" name="tskill" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
			</c:forEach></td>
		</tr>
	...
	<br>
	<center><input type="submit" name="regsubmit" value="提 &nbsp; 交" onclick="return check();"></center>
	</form>
