...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<form method="post" name="register" action="Lesson2WeekSchemeMaker">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>选修周排课选择页面</td>
		</tr>
		<tr>
			<td class="header" width="23%" align="center">选择选修课程:</td>
			<td width="25%" class="altbg2"><select name="L2_ID">

				<c:forEach var="list" items="${lesson2}">
		...
		<tr>
			<td colspan="2" class="header">选修周排课选择页面</td>
		</tr>
	</table>
	<br>
