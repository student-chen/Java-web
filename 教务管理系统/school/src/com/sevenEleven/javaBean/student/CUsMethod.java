	...
	public CstudentBean getinformation(Object userid) {
		...
		try {
			while (result.next()) {
				...
				student.setS_name(result.getString("S_NAME"));// ����
				student.setS_number(result.getString("S_NUMBER"));// �û���
				student.setS_password(result.getString("S_PASSWORD"));// ����
				student.setC_name(result.getString("C_NAME"));// �����
				student.setC_type(result.getString("C_TYPE"));// �༶����;
			}
			method.closeConn();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
