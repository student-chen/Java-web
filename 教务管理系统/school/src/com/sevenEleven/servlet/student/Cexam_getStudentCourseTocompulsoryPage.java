...
/**
 * Servlet implementation class for Servlet: Cexam_getStudentCourseTocompulsoryPage
 *
 */
 public class Cexam_getStudentCourseTocompulsoryPage extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public Cexam_getStudentCourseTocompulsoryPage() {
		super();
	}   	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("exam_compulsoryPage.jsp").forward(request, response);
	}  	  	    
}