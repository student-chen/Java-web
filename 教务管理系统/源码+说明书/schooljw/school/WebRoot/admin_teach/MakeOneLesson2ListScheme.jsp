...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<form method="post" name="register" action="OneLesson2ListSchemeMaker">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>必修课排课提交页面</td>
		</tr>
		<tr>
        ...
        <td width="25%" class="altbg2"><select name="time1">
		  ...
		  <td width="25%" class="altbg2"><select name="lesson2">
