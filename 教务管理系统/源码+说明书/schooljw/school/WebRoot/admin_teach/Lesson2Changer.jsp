...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<br>
	-->
	<form method="post" name="register" action="Lesson2UpdateServlet">

	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		class="tableborder">
		<tr>
			<td colspan="2" class="header"><a href="" target=""></a>选修课程修改 - 必填内容</td>
		</tr>
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="0" end="0">
					<input type="text" name="L2_ID" size="25" maxlength="25"
		...
		<tr>
			...
			<td class="altbg2"><c:forEach var="list" items="${mylist}">
				...
				<c:forEach var="temp" items="${list}" begin="1" end="1">
					<input type="text" name="L2_NAME" size="25" maxlength="25"
						value="${temp}">
				</c:forEach>
		...
		<tr>
			...
			<td class="altbg2"><select name="L2_NEED_ID">

				<c:forEach var="list" items="${mylist2}">
