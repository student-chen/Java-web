...
<table bgcolor="#FFFFFF" width="98%" cellpadding="0" cellspacing="0"
	...
	<br>
	-->
	<form method="post" name="register" action="ClassRegisterServlet">
	...
	<table cellspacing="1" cellpadding="4" width="98%" align="center"
		...
		<tr>
			...
			<td class="altbg2"><input type="text" name="cname" size="25"
				maxlength="25">
		</tr>
		<tr>
			<td class="altbg1" width="21%">班级类型:</td>
			<td class="altbg2"><input type="text" name="ctype" size="25"
				maxlength="25"></td>
		</tr>
