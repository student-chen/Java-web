...
/**
 * Servlet implementation class for Servlet: TeaRegisterServlet
 *
 */
 public class TeaRegisterServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    /**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    //String sql = "insert into student vaules (seq_student_p.nextval,"+cname+",'"+name+"','"+userName+"','"+password+"')";     
		  String sql = "insert into teacher values ('"+name+"','"+userName+"','"+password+"','"+skill+"')"; 
