...
<table width="199" height="431"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="18" colspan="3"><img src="../images/manage_rightTitle.GIF" width="199" height="37" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="../images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="ordermanage.jsp" >订单管理<br>
              Order Manage</a></td>
            </tr>
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="../images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="placardmanage.jsp">公告管理<br>
               Manage Placard</a></td>
            </tr>
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="../images/manage_listIco.GIF" width="10" height="11" /></td>
          ...
          <tr>
            <td height="7" colspan="3" align="center" background="../images/manage_rightKbottom.GIF"></td>
          </tr>
</table>
