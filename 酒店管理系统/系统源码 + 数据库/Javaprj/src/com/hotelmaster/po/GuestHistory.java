...
public class GuestHistory {
	...
	/*
	 * @Column(nullable=false) public Integer getGhOrderType() { return
	 * ghOrderType; } public void setGhOrderType(Integer ghOrderType) {
	...
	/*
	 * public Integer getGhState() { return ghState; } public void
	 * setGhState(Integer ghState) { this.ghState = ghState; }
	 * 
	 * @Column(nullable=false) public BigDecimal getGhTotalConsume() { return
	 * ghTotalConsume; } public void setGhTotalConsume(BigDecimal
	 * ghTotalConsume) { this.ghTotalConsume = ghTotalConsume; }
	 */
