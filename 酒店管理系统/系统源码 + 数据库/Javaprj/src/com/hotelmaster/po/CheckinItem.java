...
public class CheckinItem { // 入住登记信息类
	...
	/*
	 * @Column(nullable=false,length=32) public String getCimCheckinId() {
	 * return cimCheckinId; } public void setCimCheckinId(String cimCheckinId) {
	 * this.cimCheckinId = cimCheckinId; }
	 * 
	 * @Column(nullable=false,length=32) public String getCimRoomId() { return
	 * cimRoomId; } public void setCimRoomId(String cimRoomId) { this.cimRoomId
	 * = cimRoomId; }
	 */
	@ManyToOne
	...
	/*
	 * @Column(nullable=true) public BigDecimal getCimServiceRate() { return
	 * cimServiceRate; } public void setCimServiceRate(BigDecimal
	 * cimServiceRate) { this.cimServiceRate = cimServiceRate; }
	 * 
	 * @Column(nullable=true) public BigDecimal getCimAddRate() { return
	 * cimAddRate; } public void setCimAddRate(BigDecimal cimAddRate) {
	 * this.cimAddRate = cimAddRate; }
	 * 
	 * @Column(nullable=true) public BigDecimal getCimBedRate() { return
	 * cimBedRate; } public void setCimBedRate(BigDecimal cimBedRate) {
