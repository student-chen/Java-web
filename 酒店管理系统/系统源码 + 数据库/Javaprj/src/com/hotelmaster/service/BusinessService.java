...
public interface BusinessService {
	...
	boolean createCheckinOrder(CheckinOrder checkinOrder,
	...
	boolean createReservOrder(ReservOrder reservOrder,
	...
	void deleteReservOrder(ReservOrder reservOrder,
			List<ReservItem> reservItemList);

	void updateReservOrder(ReservOrder reservOrder,
			List<ReservItem> reservItemList);
