...
public class CheckinOrderJson {
	...
	public JSONObject getJSONObject() throws Exception {
		...
		itemJson.put("cioGuestCardCatalog", checkinOrder
				.getCioGuestCardCatalog());
		...
		String inDateTime = cioInDateTime.substring(0, cioInDateTime
				.lastIndexOf(":"));
		...
		//
		String cioPrctOutDateTime = String.valueOf(checkinOrder
				.getCioPrctOutDateTime());
		// String[] prctOutDateTime=cioPrctOutDateTime.split("\\.");
		String prctOutDateTime = cioPrctOutDateTime.substring(0,
				cioPrctOutDateTime.lastIndexOf(":"));
		itemJson.put("cioPrctOutDateTime", prctOutDateTime);
		//
		String cioPreOutDateTime = String.valueOf(checkinOrder
				.getCioPreOutDateTime());
		String preOutDateTime = cioPreOutDateTime.substring(0,
				cioPreOutDateTime.lastIndexOf(":"));
	...
	public JSONObject getReservJSONObject() throws Exception {
		...
		//
		String cioPrctOutDateTime = String.valueOf(reservOrder
				.getRoPreOutDateTime());
		// String[] prctOutDateTime=cioPrctOutDateTime.split("\\.");
		String prctOutDateTime = cioPrctOutDateTime.substring(0,
				cioPrctOutDateTime.lastIndexOf(":"));
		itemJson.put("cioPrctOutDateTime", prctOutDateTime);
		//
		String cioPreOutDateTime = String.valueOf(reservOrder
				.getRoPreOutDateTime());
		String preOutDateTime = cioPreOutDateTime.substring(0,
				cioPreOutDateTime.lastIndexOf(":"));
		itemJson.put("cioPreOutDateTime", preOutDateTime);
	...
	public JSONObject getReservItemJsonObject() throws Exception {
		...
		for (ReservItem item : reservItemList) {
			/*
			 * ,'rmId' ,{name:'rmPrctPrice',type:'float'}
			 * ,{name:'rmState',type:'int'} ,'rmCatalog' ,'rmPrctDiscount'
			 * //Room的预设折扣 ,'rmSetPrctDiscount' //Room的实际折扣 ,'rmSetPrctPrice'
			 * //Room的实际价格
			 */
