...
public class GuestInforUtil {
	...
	public static Guest dealGuestAddRequest(HttpServletRequest request)
			throws Exception {
	...
	public static Guest dealGuestUpdateRequest(HttpServletRequest request)
			throws Exception {
		...
		guest.setGtCreateTime(Timestamp.valueOf(jsonObject
				.getString("gtCreateTime")));
	...
	public static String dealGuestDelRequest(HttpServletRequest request)
			throws Exception {
		String gtId = null;
	...
	public void updateGuestInforRequest(HttpServletRequest request,
			String guestID) throws Exception {
