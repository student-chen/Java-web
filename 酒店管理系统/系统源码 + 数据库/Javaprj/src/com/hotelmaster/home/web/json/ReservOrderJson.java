...
public class ReservOrderJson {
	...
	public JSONObject getJSONObject() throws Exception {
		...
		for (ReservOrder item : reservOrderList) {
			...
			String roInDateTime = String.valueOf(new SimpleDateFormat(
					"yyyy-MM-dd").format(item.getRoInDateTime()));
			...
			String roPreOutDateTime = String.valueOf(new SimpleDateFormat(
					"yyyy-MM-dd").format(item.getRoPreOutDateTime()));
	...
	public JSONObject getInfoJSONObject() throws Exception {
		...
		// itemJson.put("roGroupName",item.getRoGroupName());
		itemJson.put("i_roGuestCardCatalog", reservOrder
				.getRoGuestCardCatalog());
		...
		String roInDateTime = String.valueOf(new SimpleDateFormat("yyyy-MM-dd")
				.format(reservOrder.getRoInDateTime()));
		...
		// itemJson.put("",item.getRoPreAssignRoom());
		String roPreOutDateTime = String.valueOf(new SimpleDateFormat(
				"yyyy-MM-dd").format(reservOrder.getRoPreOutDateTime()));
