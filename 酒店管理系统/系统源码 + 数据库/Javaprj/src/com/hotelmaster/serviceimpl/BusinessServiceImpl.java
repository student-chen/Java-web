...
public class BusinessServiceImpl implements BusinessService {
	...
	/*
	 * public void createBalancement(Balancement balancement) { // TODO
	 ...
	 * 查询可供预定的房间信息(bg)
	 */
	public List<Room> findAvailReservRooms(Timestamp fromDate,
			Timestamp toDate, String rmCatalog, Page page) {
	 ...
	 * 创建登记信息
	 */
	public boolean createCheckinOrder(CheckinOrder checkinOrder,
	...
	/*
	 * public String createBalancement(Balancement balancement) { String bmId =
	 * balancementDao.createBalancement(balancement);
	 */
	/**
	 * 结账
	 */
	public String createBalancement(Balancement balancement) {
		String bmId = balancementDao.createBalancement(balancement);// 创建结账信息
		String cioId = balancement.getBmCheckinOrderId();// 获得入住登记订单编号
		CheckinOrder checkinOrder = checkinOrderDao.query(cioId);// 查找入住登记信息
		checkinOrder.setCioTotalRate(balancement.getBmTotalRate());// 设置总费用
