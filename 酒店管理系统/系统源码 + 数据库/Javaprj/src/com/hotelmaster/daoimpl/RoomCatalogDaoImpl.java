...
public class RoomCatalogDaoImpl extends GenericHibernateDao<RoomCatalog>
		implements RoomCatalogDao {
	...
	public List<RoomCatalog> showAllRoomCatalog() {// 查找所有的客房类型
		...
		return queryForList("select count(*) from RoomCatalog",
				"from RoomCatalog", null, page);
	}
