...
public class BaseInfoDaoImpl extends GenericHibernateDao<BaseInfo> implements
		BaseInfoDao {
	...
	public BaseInfo findValueByName(String bioName) {
		...
		List<BaseInfo> values = hibernateTemplate.find(
				"from BaseInfo baseInfo where baseInfo.bioName=?", bioName);
		return values.get(0);
	}
