...
public class GuestHistoryDaoImpl extends GenericHibernateDao<GuestHistory>
		implements GuestHistoryDao {
	...
	public List<GuestHistory> findAll(Page page) {
		// TODO Auto-generated method stub
		return queryForList("select count(*) from GuestHistory",
				"from GuestHistory", null, page);
	}
	...
	public long getHistoryTotalCount(String gtId) {
		...
		return (Long) queryForObject(
				"select count(*) from GuestHistory where ghGuestId = ?",
				new Object[] { gtId });
	}
	...
	public GuestHistory queryHistoryInfo(String gtId) {
		// TODO Auto-generated method stub
		List<GuestHistory> guestHistory = hibernateTemplate
				.find("from GuestHistory where ghGuestId='" + gtId + "'");
