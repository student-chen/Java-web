...
public class TeacherDAO extends HibernateDaoSupport implements ITeacherDAO  {
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#save(models.Teacher)
	 */
	...
	/* (non-Javadoc)
	 * @see dao.ITeacherDAO#delete(models.Teacher)
	 */
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#findById(java.lang.Integer)
	 */
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#findByExample(models.Teacher)
	 */
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see dao.ITeacherDAO#findByTName(java.lang.Object)
	 */
	...
	/* (non-Javadoc)
	 * @see dao.ITeacherDAO#findByTPhone(java.lang.Object)
	 */
	public List findByTPhone(Object TPhone
	) {
		return findByProperty(_TPHONE, TPhone
		);
	}
	

	/* (non-Javadoc)
	 * @see dao.ITeacherDAO#findAll()
	 */
	public List findAll() {
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#merge(models.Teacher)
	 */
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#attachDirty(models.Teacher)
	 */
    ...
    /* (non-Javadoc)
	 * @see dao.ITeacherDAO#attachClean(models.Teacher)
	 */
	...
	public static ITeacherDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (ITeacherDAO) ctx.getBean("TeacherDAO");
	}
}