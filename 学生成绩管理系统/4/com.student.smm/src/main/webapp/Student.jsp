      ...
      <form class="form-horizontal" action="saveStudent" method="post">    
		  ...
		  <div class="form-group">
		    <label class="col-sm-2 control-label">分配班级:</label>
		     <div class="col-sm-10"> 
		      <select name="classids" id="classids" class="form-control">
		                <option value="">请选择班级</option>
                        <option value="1">普通班</option>
                        <option value="2">重点班</option>
                        <option value="3">励志班</option>
                      </select> 
  ...
  <body> 
    ...
    <div class="navbar navbar-fixed-top">
 	...
 	<div class="tab-pane" style="padding: 20px 20px 10px;">			
	    ...
	    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <button data-toggle="modal" class="btn btn-primary" data-target=".bs-example-modal-lg">添加学员</button></td>
	    <button type="button" onclick="delet()" class="btn btn-primary">批量删除</button>
	    <a href="xiazai"><button type="button" class="btn btn-primary"><span class="am-icon-sign-out"></span>excel导出</button></a>
					<!-- 上传excel文件 -->
