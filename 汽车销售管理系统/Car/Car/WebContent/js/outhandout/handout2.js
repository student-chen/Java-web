...
function getAllByPage()
{
	  $('#tb_departments').bootstrapTable({
            url: path+'fujian.do?method=all1',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            dataType:'json',
            ...
            columns: [{
            ...
            },
             {
                 ...
                 formatter : function(value, row, index) {  
                	 var e="";
                	 e='<div class="ckinfo"><button type="button" class="btn btn-outline btn-default">'
              			+'<span><a href="'+path+'outhandout/fujian.jsp?hid='+value+'">查看详细</a></span></button></div>';
                	 return e; 
                  }
             }]
        });
