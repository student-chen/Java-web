            ...
            },
            {
                 ...
                 formatter : function(value, row, index) { 
                	 ...
                	 if($.inArray("查询车辆入库明细",ids)==-1){
                		 ...
                		 e='<div class="rkinfo"><a href="'+path+'incarmx/incarmx.jsp?id='+value+'&name='+row.detailname+'&did='+row.detailid+'"><button type="button" class="btn btn-outline btn-default">'
             ...
             },
             {
                 ...
                 formatter : function(value, row, index) { 
                	 var e="";
                		 e='<div class="rkinfo"><a href="'+path+'outcar/incarmx.jsp?id='+value+'"><button type="button" class="btn btn-outline btn-default">'
                   			+'<span>出库操作</span></button></a></div>';
                	 return e; 
                  }
             },
             ]
