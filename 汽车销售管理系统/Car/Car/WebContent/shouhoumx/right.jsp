<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/shouhoumx/shouhoumx.js">
	</script>
						...
						<div class="smart-widget-inner" style="height: 100%;">
							...
							<div class="smart-widget-body" id="divbody">
					        	 <table id="tb_departments"></table>
					      	 	 ...
					      	 	 <input type="hidden"  id="name" value="<%=new String(request.getParameter("name").getBytes("ISO-8859-1"),"utf-8")%>">
							</div>
