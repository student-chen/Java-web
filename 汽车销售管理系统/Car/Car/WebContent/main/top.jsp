		...
		<header class="top-nav">
			<div class="top-nav-inner">
				<div class="nav-header">
					...
					<a href="${pageContext.request.contextPath}/main/main.jsp" class="brand"> <i class="fa fa-smile-o"></i><span
						class="brand-name">骏马武汉分公司销售信息平台</span>
					</a>
				</div>
			...
			<script type="text/javascript">
					 $.ajax({
		                 url:'${pageContext.request.contextPath}/purchase.do?method=allcount',
		                 type:'post',
		                 data:'',
		                 dataType:'json',
				           success:function(data){
								if(data!=0){
									layer.open({
								      	  ...
								      	  ,content: '<div style="width:200px;height:100px">您有<span style="color:red;">&nbsp;'+data+'&nbsp;</span>条新的消息</div>'
								      	  ,btn: ['查看消息']
									      ,btn1:function(index, layero){
									    	  window.location.href="${pageContext.request.contextPath}/purchase/purchase.jsp?flag=1"; 
								      	  }
								      	  ,btnAlign: 'c' //按钮居中
								      	  ,shade: 0 //不显示遮罩
								      	  ,yes: function(){
