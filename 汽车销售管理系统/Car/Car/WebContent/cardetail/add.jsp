...
<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/cardetail/add.js"></script>
...
<body>
			...
			<div class="input-group" style="width: 65%; margin-left: 20px;">
				...
				<input class="form-control" id="time" type="text"  onclick="return Calendar('time');" placeholder="请输入出厂时间"/>
			</div><br>
