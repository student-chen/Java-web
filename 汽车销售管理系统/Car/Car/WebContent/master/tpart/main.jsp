...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/master/main.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/master/master.js"></script>
<script src="${pageContext.request.contextPath}/js/layer/layer.js"></script>
		...
		<div class='row'>
			<div class='col-md-12 col-sm-12'>
				<div class="btn-group" style="float: right;">
					<button type="button" class="btn btn-outline btn-default" id="addMaster">
