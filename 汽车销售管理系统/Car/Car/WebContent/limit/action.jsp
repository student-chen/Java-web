...
<%@ include file="../limit/left1.jsp"%>
	...
	<li class="active" id="cz"><a href="${pageContext.request.contextPath}/limit/action.jsp"><span class="submenu-label">模块具体操作</span></a></li>
...
<!-- 主体 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/limit/actions.js"></script>
