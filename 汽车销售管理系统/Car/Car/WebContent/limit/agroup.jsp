...
<%@ include file="../limit/left1.jsp"%>
	...
	<li class="active" id="qx"><a href="${pageContext.request.contextPath}/limit/agroup.jsp"><span class="submenu-label">用户组权限</span></a></li>
<%@ include file="../limit/left2.jsp"%>
<!-- 主体 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/limit/agroup.js"></script>
