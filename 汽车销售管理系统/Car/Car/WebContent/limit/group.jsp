...
<%@ include file="../limit/left1.jsp"%>
	...
	<li class="active" id="yh"><a href="${pageContext.request.contextPath}/limit/group.jsp"><span class="submenu-label">用户组设置</span></a></li>
...
<!-- 主体 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/limit/group.js"></script>
