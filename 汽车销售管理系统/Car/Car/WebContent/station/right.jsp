<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/station/station.js">
	</script>
				...
				<div class="smart-widget widget-dark-blue">
						<div class="smart-widget-header">
							<div id="toolbar" class="btn-group">
								<button type="button" class="btn btn-outline btn-default" id="addGw">
						...
						<div class="smart-widget-inner" style="height: 100%;">
							...
							<div class="smart-widget-body" id="divbody">
								<iframe name="toppage" width=100% height=100% marginwidth=0
									...
									src="${pageContext.request.contextPath}/station/tpart/main.jsp"></iframe>
							</div>
