...
<%@ include file="../outhandout/left2.jsp"%>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/outhandout/fujian.js">
	</script>
				...
				<div class="smart-widget widget-dark-blue">
						...
						<div class="smart-widget-inner" style="height: 100%;">
							...
							<div class="smart-widget-body" id="divbody">
								 ...
								 <input type="hidden"  id="hids" value="<%=request.getParameter("hid") %>">
							</div>
