						...
						<ul class="accordion">
							...
							<li class="openable bg-palette1 open">
								...
								<ul class="submenu third-level">
									...
									<li class="openable open" id="zpck">
										...
										<ul class="submenu fourth-level">
												...
												<li id="zsck" class="active"><a href="${pageContext.request.contextPath}/outhandout/handout2.jsp"><span class="submenu-label">赠送出库</span></a></li>
										</ul>
									</li>
