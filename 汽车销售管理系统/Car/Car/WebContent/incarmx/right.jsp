<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/incarmx/incarmx.js">
	</script>
				...
				<div class="smart-widget widget-dark-blue">
						...
						<div class="smart-widget-inner" style="height: 100%;">
							...
							<div class="smart-widget-body" id="divbody">
								 <div id="tools"><span style='color: red;font-weight: bold;'>入库总量为：<b></b></span></div>
								 <br>
