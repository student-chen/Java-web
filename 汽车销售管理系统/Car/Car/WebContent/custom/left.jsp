					...
					<div class="main-menu">
						<ul class="accordion">
							...
							<li class="openable bg-palette4">
								...
								<ul class="submenu third-level open">
									<li id="pp" class="active"><a href="${pageContext.request.contextPath}/carsort/carsort.jsp"><span class="submenu-label">汽车品牌</span></a></li>
							...
							<li class="openable bg-palette2 open">
								...
								<ul class="submenu third-level">
									<li id="kh" class="active"><a href="${pageContext.request.contextPath}/custom/custom.jsp"><span class="submenu-label">客户管理</span></a></li>
