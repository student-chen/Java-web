	...
	<table class="imagetable">
		...
		<%
			for (course crs : cs) {
				...
				String tc = crs.getTeacher();
				if(tc.equals(session.getAttribute("name"))){
		%>
		...
		<%
			...
			out.print("<td>删除课程</td>");
			}}
		%>
		<tr>
	</table>
	<p>
		共<%=st.size()%>条记录     <a href="ncourse.jsp">新建课程</a> <a href="nscore">修改成绩</a>
		<a href="../index.jsp">退出</a>
		<a href="update0?id=<%=session.getAttribute("id").toString()%>">修改</a>
		<a href="./tclist">您所教的课程信息</a>
	</p>
</body>
</html>
