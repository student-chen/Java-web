...
<%
	...
	String id0=request.getParameter("id").toString();
	if (!id.equals(id0)) {
...
<body text="#000000">
	...
	%>
	<form method="POST" action="update0">
		<table width="680" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;" background=indeximg/head.jpg height="300">
			...
			<tr bgcolor="#FFFFFF">
				...
				%>
				<td height="25" width="365">
					<div align="left"> <select type="radio" name="type"><option value="1" checked >学生</option> <%
					;
					} else if (user.getType().equals("2")) {
				%>
				
				<option value="2" checked >教师</option>

				<%
					;
					} else {
				%>
				<option value="3" checked >管理员</option>
				</select></div>
				</td>
