								...
								<td>
									<table class="small" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td colspan="2">
												<a class="title"
													href="${pageContext.request.contextPath}/view/updatedoctorpasssword.jsp"
													target="main">&nbsp;修改密码</a>
											</td>
										</tr>
									</table>
				...
				<tr>
					<td>
						<img
							...
							width="16" height="18" class="outline" id="MEMU_55" style="cursor:hand">
					</td>
					<td>
						<img
					...
					<td colspan="2">
						<a class="title" href="as" onclick="MEMU_55.click();return false;">&nbsp;会诊</a>
					</td>
				</tr>
			</table>
			<table class="small" border="0" cellspacing="0" cellpadding="0"
					...
					<td>
						<table class="small" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td><img src="${pageContext.request.contextPath}/imgs/menu/@bease.gif"
										border="0">
								</td>
								<td colspan="2">
									<a class="title" href="patientServlet?isfinished=0"target="main">&nbsp;查看病人</a>
								</td>
							</tr>
						</table>
						<table class="small" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<img src="${pageContext.request.contextPath}/imgs/menu/tree_blank.gif"
										border="0">
								</td>
								<td>
									<img src="${pageContext.request.contextPath}/imgs/menu/@my2.gif"
										border="0">
								</td>
								<td colspan="2">
									<a class="title"
										href="diagnosisServlet?opertion=0"
										target="main">&nbsp;我的诊断书</a>
								</td>
							</tr>
						</table>
						...
						<table class="small" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td colspan="2">
									<a class="title"
										href="operationServlet?opertion=2"
										target="main">&nbsp;我的手术</a>
								</td>
							</tr>
						</table>
						<table class="small" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<img src="${pageContext.request.contextPath}/imgs/menu/tree_blankl.gif"	border="0">
								</td>
								<td>
									<img src="${pageContext.request.contextPath}/imgs/menu/ip_search.gif" border="0">
								</td>
								<td colspan="2">
									<a class="title"
										href="inHospitalServlet?opertion=0"
										target="main">&nbsp;我的住院</a>
								</td>
							</tr>
						</table>
